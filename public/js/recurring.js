    ...
    try {
      ...
      tbody.innerHTML = list.map(r => `
        <tr>
          ...
          <td>
            <span class="badge" style="background: ${r.category_color}25; color: ${r.category_color}; border: 1px solid ${r.category_color}40; padding: 4px 8px; border-radius: 6px; font-weight: 600;">
              ${r.category_name}
            </span>
          </td>
